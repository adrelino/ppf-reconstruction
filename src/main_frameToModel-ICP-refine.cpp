...
int main(int argc, char * argv[])
{
    ...
    //Isometry3f Pref(LoadingSaving::loadMatrix4f("bunny/posesMarkerN_To_PLY-ppf.txt"));
    ...
    for(int i=0; i<=36; i++){
        ...
        //ss2<<"bunny/depth-poses/cloudToPLY-coarse_"<<i<<".txt";


        //LoadingSaving::saveMatrix4f(ss2.str(),P.matrix());

        //all.append(PointCloudManipulation::projectPointsAndNormals(P, cloud));
        //ss2<<"P:"<<i<<endl;
        ...
        //Isometry3f Pg = P;//PointPairFeatures::getTransformationBetweenPointClouds(trainedModel,sSmall);
        ...
        Visualize::addCameraPoseGroundTruth(P_Iterative_ICP);
